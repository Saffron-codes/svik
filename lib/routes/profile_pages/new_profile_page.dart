...
class _NewProfilePageState extends State<NewProfilePage>
  ...
  static final mySystemTheme = SystemUiOverlayStyle.light
      .copyWith(systemNavigationBarColor: Color(0xff242232),statusBarColor: Color(0xff202225));
              ...
              return [
                SliverAppBar(
                  ...
                  actions:  [
                    ...
                    IconButton(onPressed: ()=> editUserSheet(context,currentUser), icon: Icon(Icons.edit))
                  ],
                  expandedHeight: 260,
                  pinned: true,
                  flexibleSpace: FlexibleSpaceBar(
                    ...
                    background: Hero(
                      tag: "",
                      child: CachedNetworkImage(imageUrl: currentUser.photourl.toString(),fit: BoxFit.cover,)
                    ),
                    // background: Hero(
                    //   tag: "p-${widget.index}",
                    //   child: Image.network(

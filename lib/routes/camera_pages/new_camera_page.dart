...
class CamPage2 extends StatefulWidget {
  final List<CameraDescription> cameras;
  const CamPage2({Key? key, required this.cameras}) : super(key: key);

  @override
  State<CamPage2> createState() => _CamPage2State();
}

class _CamPage2State extends State<CamPage2>
  ...
  void takePic() async {
    try {
      ...
      await _picture.copy('$path/${_pic.name}').whenComplete((){
